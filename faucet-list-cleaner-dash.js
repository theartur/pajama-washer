...
var original = fs.readFileSync("clean-addr-dash.txt", 'utf8');
...
fs.writeFile("faucetz-list-clean-dash.js", payload, function(err) {
    if(err) {
        return console.log(err);
    }

    console.log("Clean faucetz available in 'faucetz-list-clean-dash.js'");
});