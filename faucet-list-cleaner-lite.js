...
var original = fs.readFileSync("clean-addr-lite.txt", 'utf8');
...
// Faucetz.extracted = {
//     "wallet": "LUz64yuE92BTTuh1QUAeUpohqwDfGdy1Mj",
//     "results": [
//         {
//             "clean": "true",
...
//             "link": "http://playbitco.in/?ref=LUz64yuE92BTTuh1QUAeUpohqwDfGdy1Mj",
//             "name": "playbitco.in",
...
function formatFinalList(list) {
    ...
    list.forEach(function (addr, i) {
        if (addr !== "") {
            ...
            url += "?r=LUz64yuE92BTTuh1QUAeUpohqwDfGdy1Mj";
...
var payload = 'Faucetz.lite = {' +
    '"wallet": "LUz64yuE92BTTuh1QUAeUpohqwDfGdy1Mj",' +
    '"results": ' + JSON.stringify(formatFinalList(lista)) +
'};';

fs.writeFile("faucetz-list-clean-lite.js", payload, function(err) {
    if(err) {
        return console.log(err);
    }

    console.log("Clean faucetz available in 'faucetz-list-clean-lite.js'");
});