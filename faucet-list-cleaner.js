...
var original = fs.readFileSync("clean-addr.txt", 'utf8');
...
var payload = 'Faucetz.extracted = {' +
    '"wallet": "1NnFcBCTTcmEYH4LCweFVogcxq6K21zWXf",' +
    '"results": ' + JSON.stringify(formatFinalList(lista)) +
'};';

fs.writeFile("faucetz-list-clean.js", payload, function(err) {
    if(err) {
        return console.log(err);
    }

    console.log("Clean faucetz available in 'faucetz-list-clean.js'");
});